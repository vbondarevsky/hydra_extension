...
Функция GetPolicy(Запрос)
	
	ПарольнаяПолитика = Новый Структура;
	ПарольнаяПолитика.Вставить("strong_passwords", );
	ПарольнаяПолитика.Вставить("minimum_length", );
	
	ПарольнаяПолитика.Вставить("minimum_age", );
	ПарольнаяПолитика.Вставить("maximum_age", );
	ПарольнаяПолитика.Вставить("inactive_period", );
	ПарольнаяПолитика.Вставить("password_history", );
